/*
    Intention Repeater Spiritual Chat Client v2.4 created by Thomas Sweet.
...
#define PROCESS_STATEMENT " In a way I can understand, using Octave Tech.";
